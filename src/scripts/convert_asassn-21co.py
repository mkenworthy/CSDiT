...
fin='ASASSN-21co/light_curve_1a860fbb-401f-4971-b38b-6d4f75764a2c.csv'
...
print(f'cutoff for error in g:{cum_reqg:5.2f}')
...
print(f'rejecting noisy points in g (>{cum_reqg:5.3f}) data separately in ASASSN')
