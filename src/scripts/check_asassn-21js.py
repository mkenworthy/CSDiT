...
#ax.errorbar(tV['MJD'],tV['fnorm'],yerr=tV['fnormerr'],label='V',fmt='.',alpha=0.1)
#ax.errorbar(tg['MJD'],tg['fnorm'],yerr=tg['fnormerr'],label='g',fmt='.',alpha=0.1)
...
tn.write(paths.data / 'obs_ASASSN-21js_ASASSN.ecsv',format='ascii.ecsv',overwrite=True)
